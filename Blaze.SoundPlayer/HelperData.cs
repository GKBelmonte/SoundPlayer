...
namespace Blaze.SoundPlayer
{
    ...
    public delegate float WaveGenerator(int sampleRate, int sampleNumber, float freq);
    ...
    public static class Helpers
    {
        ...
        public static string NoteLetterGetter(int letterModifier)
        {
        ...
        static public float GetFrequency(this Note self)
        {
            var freq = A0Frequency * MathExtensions.PowerOfTwo(self.mOctave);
            var modifier = NoteLetterToKeyNumber(self.mStep)-NoteLetterToKeyNumber("A");
